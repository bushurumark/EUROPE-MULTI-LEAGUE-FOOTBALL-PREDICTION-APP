...
def compute_mean_for_teams(home_team, away_team):
    ...
    # Prepare the input DataFrame by converting mean_data to a single-row DataFrame
    mean_data = mean_data.drop(labels=['HomeTeam', 'AwayTeam'])  # Drop team names
