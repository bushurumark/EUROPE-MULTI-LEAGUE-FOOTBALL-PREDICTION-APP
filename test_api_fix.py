...
def test_analytics_engine():
    """Test the AnalyticsEngine with various team names."""
    try:
        ...
        for team in test_teams:
            try:
                ...
                # Test get_injury_suspensions
                injuries = engine.get_injury_suspensions(team)
...
if __name__ == "__main__":
    ...
    test1_success = test_analytics_engine()
    ...
    if test1_success and test2_success:
        print("🎉 All tests passed! The API fixes should work correctly.")
    else:
